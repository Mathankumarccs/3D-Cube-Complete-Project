...
public class AddCustomerGGrenderer : MonoBehaviour
{
    RawImage rawImage;
    ...
    void Start()
    {
        ...
        Debug.Log("UnityGG Button Start called inside custom renderer");
        ...
        {
            Debug.Log("UnityGG Button Delegate called inside custom renderer");
            if (brandedTexture != null)
            {
                Debug.Log("UnityGG Button branded texture found");
                //Step Delegate-A
                rawImage = GetComponent<RawImage>();
                if (rawImage != null)
                {
                    Debug.Log("UnityGG Button branded texture Assigned");
            ...
            if (!isBrandedTexture)
            {
                Debug.Log("UnityGG Button branded texture not found");
                //Step Delegate-B
